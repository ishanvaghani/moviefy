...
interface MovieApi {
    ...
    suspend fun getMovieCredits(@Path("movie_id") id: Int): Response<CreditResponse>
    ...
    suspend fun getTVShowGenres(): Response<GenreResponse>

    @GET("tv/{tvShow_id}/credits?api_key=$API_KEY")
    suspend fun getTVShowCredits(@Path("tvShow_id") id: Int): Response<CreditResponse>
}